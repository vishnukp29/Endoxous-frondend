...
function Page3() {
  ...
  console.log(order && order, "=========== Ordder Page");
  console.log(tickets && tickets, "=========== tickets Page");
  ...
  }, [id, dispatch, error, ticketsError]);
        ...
        <div className="section2">
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div>
                    <input
                      ...
                      style={{
                        backgroundColor:
                          order?.orderStatus === "Shipped" ? "green" : "red",
                      }}
                    />{" "}
                    {order?.orderStatus}
                  </div>
              ...
              <div className="p3-activity-bg">
                ...
                <div>
                  <div>
                    ...
                    Order Placed
                    <p>
                      Today, 06:10 PM <DateFormatter date={order?.createdAt} />{" "}
                    </p>
                  </div>
                  <div>
                    <input
          ...
          >
            <div className="container-fluid px-5 d-flex align-items-end">
              <button className="btn btn-outline bg-warning " type="submit">
                Ship Order
              </button>
            </div>
          </footer>
